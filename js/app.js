(() => {
    ...
    function initSliders() {
        if (document.querySelector(".content-works__slider")) new core(".content-works__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".header-works__arrow.header-works__arrow--left",
                nextEl: ".header-works__arrow.header-works__arrow--right"
            },
            breakpoints: {
                280: {
                    slidesPerView: 1.2,
